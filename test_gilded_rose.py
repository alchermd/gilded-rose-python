...
from gilded_rose import Item, GildedRose, NORMAL_ITEM_NAME, LEGENDARY_ITEM_NAME, AGED_BRIE_ITEM_NAME, \
    BACKSTAGE_PASS_ITEM_NAME
...
def test_sell_in_is_not_reduced_for_legendary_items():
    items = update_quality([Item(LEGENDARY_ITEM_NAME, 5, 0)])
...
def test_quality_of_items_never_go_above_50():
    items = update_quality([Item(BACKSTAGE_PASS_ITEM_NAME, 5, 50)])
